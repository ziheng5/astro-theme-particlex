...
export const iconLinks = [
  { label: "GitHub", icon: "github", theme: "brands", href: "https://github.com/your-name" },
  { label: "Bilibili", icon: "bilibili", theme: "brands", href: "https://www.bilibili.com/" },
  { label: "Discord", icon: "discord", theme: "brands", href: "https://discord.com/" },
  { label: "Email", icon: "envelope", theme: "solid", href: "mailto:hello@example.com" }
];
...
export const friends = [
  ...
  { name: "GitHub", url: "https://github.com/", avatar: "https://github.githubassets.com/favicons/favicon.svg", desc: "Host your template repository and deploy with Actions." }
];
...
export const favorites = [
  {
    name: "Documentation",
    items: [
      { name: "Astro Docs", url: "https://docs.astro.build/", desc: "Official Astro documentation.", icon: "book" },
      { name: "Markdown Guide", url: "https://www.markdownguide.org/", desc: "A quick reference for Markdown syntax.", icon: "book" }
    ]
  },
  {
    name: "Tools",
    items: [
      { name: "Font Awesome", url: "https://fontawesome.com/", desc: "Icon set used by the theme UI.", icon: "icons" }
    ]
  }
];
